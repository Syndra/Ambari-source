  ...
  "hive": {
    "ui": {
      "customizeText":{
        ...
        'addRowFormat':"Add Row Format",
        'fieldTerminate':"Fields Terminated By",
        'lineTerminate':"Lines Terminated By",
        'nullDefine':"Null Defined As",
        'escapeDefine':"Escape Defined As",
        'key':"KEY",
        'value':"VALUE",
        'addProperties':"Add New Properties",
        'newJob':"NEW JOB",
        'newTable':"NEW TABLE",
        ...
        'includeCol':"INCLUDE COLUMNS",
        'tableStatStale':"Table statistics might be stale. Please consider recomputing statistics.",
